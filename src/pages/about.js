                ...
                <div className="about_hero">
                    ...
                    <div className="about_bio">
                        ...
                        <p className="about_bio_content">My eagerness for novelty also extends to my hobbies. In my free time, I like to read non-fiction,
                         especially on history and anthropology. The past fascinates me, with books sharing the experiences of others throughout time. Watching 
                         films is my second love; I'd never pass on the opportunity to pick up popcorn and binge through a couple of movies. I also enjoy playing 
                         squash with friends and trying to figure out how my camera works.</p>
                    </div>
                </div>
            </div>
        </body>
